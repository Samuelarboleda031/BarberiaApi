...
public partial class BarberiaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Agendamiento>(entity =>
        {
            ...
            entity.HasOne(d => d.Cliente).WithMany(p => p.Agendamientos).HasForeignKey(d => d.ClienteId).IsRequired(false).OnDelete(DeleteBehavior.Restrict);
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            entity.Property(e => e.Stock).HasDefaultValue(0).IsRequired();
            entity.Property(e => e.Estado).HasDefaultValue(true);
        ...
        modelBuilder.Entity<Venta>(entity =>
        {
            ...
            entity.Property(e => e.CreditoBarberoUsado).HasPrecision(18, 2).HasDefaultValue(0m);
        ...
        modelBuilder.Entity<CreditoBarbero>(entity =>
        {
            entity.HasKey(e => e.Id);
        ...
        {
            entity.HasKey(e => e.Id);
            entity.ToTable("AbonosCreditoBarbero");
